...
if operator == '+':
    ...
    print(str(num1) + " * " + str(num2) + " = " + str(multiplicacion))
elif operator == '/':
    try:
...
calculo_suma = Calculo(3, 2, Operation.SUMAR)
calculo_resta = Calculo(2, 0, Operation.RESTAR)
calculo_multiplicacion = Calculo(4, 5, Operation.MULTIPLICAR)
calculo_division = Calculo(5, 2, Operation.DIVIDIR)
calculo_potencia = Calculo(4, 4, Operation.POTENCIA)
calculo_raiz = Calculo(2, 0, Operation.RAIZ)

calculos = [Calculo(3, 2, Operation.SUMAR), Calculo(2, 0, Operation.RESTAR), Calculo(4, 5, Operation.MULTIPLICAR), Calculo(5, 2, Operation.DIVIDIR), Calculo(4, 4, Operation.POTENCIA), Calculo(2, 0, Operation.RAIZ)]
